...
function [SystemDisplacement, SystemStrength] = AnalyzeSSUsingDCMWithMNR(SpringConnectivity, NDOFs,...
...
for Increment = 1:MaxNIncrements
    ...
    for Iteration = 1:MaxNIterations
        ...
        if Iteration == 1
            ...
            if det(GlobalStiffness(2:end, 2:end)) == 0 || rcond(GlobalStiffness(2:end, 2:end)) < eps
                break
            end
